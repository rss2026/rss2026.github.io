...
<p style="text-align: center; margin: 16px 0;">
  <img src="{{ site.baseurl }}/images/workshops_2026/rss_uts_map.png" alt="Map of the three UTS buildings hosting RSS 2026 workshops" style="max-width: 100%; height: auto; border: 1px solid #e0e0e0; border-radius: 6px;" />
</p>

An interactive campus map is also available at <a href="https://maps.uts.edu.au/map.cfm" target="_blank" rel="noopener">maps.uts.edu.au</a>.

* The **Workshop Information Desk** is located on **Level 2 of Building 11**, near the lifts.
* **Coffee** will be available on **Levels 0 and 1 of Building 11**.
* **Morning tea** will be served near each workshop venue, adjacent to the poster session areas.
...
<table class="table table-striped table-workshop">
    <thead>
        <tr>
            ...
            <th width="24%">Poster Session Location</th>
