...
* Posters must be A0 (841 wide x 1189mm high) and portrait orientation.
* Posters must be printed by presenters prior to arrival at the conference.
* Poster boards and adhesives will be provided and available at registration desk.
* Posters must be installed in The Gallery at least 10 minutes prior to the start of your session.
* Authors are not allocated to a poster board, and you are welcome to choose an available one at your assigned time.
* Posters should be removed directly after your assigned poster session, and posters that are left on boards may be disposed of.

[Local Poster Printing Options](https://drive.google.com/file/d/1Z6CDKlXlUSk8QbhOTsRXOknwDcFMwTxC/view?usp=sharing){:target="_blank"}
